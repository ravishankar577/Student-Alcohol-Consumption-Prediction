...
def main():
    ...
    input_matrix = input_dataframe.values.astype(np.float32)
    output_matrix = output_dataframe.values.astype(np.float32)
    ...
    with tf.Session() as sess:
        ...
        if mode == "train":
            ...
            print("Probability percentage for Alcohol consumption on weekdays:",output[0][0]*100)
            print("Probability percentage for Alcohol consumption on weekends:",output[0][1]*100)
